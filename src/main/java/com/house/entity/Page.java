...
import com.house.exception.KOError;
import com.house.exception.KOException;
...
public class Page {
    ...
    public Page(Long pageIndex, Long pageSize) {
        ...
        if (pageIndex > 0L && pageSize > 0L) {
            if (pageSize > 1000L) {
                throw new KOException(KOError.PAGER_PARAMETER_IS_NOT_CORRECT, "Page Size too large, limit:1000");
            } else {
                this.pageIndex = pageIndex;
                this.pageSize = pageSize;
            }
        } else {
            throw new KOException(KOError.PAGER_PARAMETER_IS_NOT_CORRECT);
        }
    }
    ...
    public void setPageSize(Long pageSize) {
        ...
        if (pageSize <= 0L) {
            ...
            throw new KOException(KOError.PAGER_PARAMETER_IS_NOT_CORRECT, "Page Size too large");
        } else {
            this.pageSize = pageSize;
        }
    }
